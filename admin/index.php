...
try {
    ...
    // 統計情報を表示
    echo "保留中: " . htmlspecialchars($stats['pending_count'] ?? 0);
    echo "承認済: " . htmlspecialchars($stats['approved_count'] ?? 0);
    echo "却下: " . htmlspecialchars($stats['rejected_count'] ?? 0);
    echo "総登録数: " . htmlspecialchars($stats['total_count'] ?? 0);
} catch (Exception $e) {
